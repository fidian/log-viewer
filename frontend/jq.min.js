...
`)});var nt=_(Ae=>{"use strict";Object.defineProperty(Ae,"__esModule",{value:!0});Ae.evaluate=void 0;var se=nr(),c=A(),Bn=ir(),oe=Ye(),Q=P(),pr=or(),fr=lr(),Vn=K(),Jn=Qe(),tt=ne(),hr=cr(),Kn=Ue(),q=Ze(),zn=Ge();function Rn(t){let e=(0,c.isAtom)(t)?` "${t}"`:"";return new Q.JqEvaluateError(`${(0,c.typeOf)(t)}${e} is not iterable`)}function dr(){return new Q.JqEvaluateError("Array slice indices must be numbers")}var ae=class extends Q.JqEvaluateError{constructor(e){super(`Label ${e} is not defined`),this.value=e}};function*Wn(t,e){let r=new rt;yield*(0,c.generateValues)(r.evaluate(t.expr,(0,c.generateItems)(e)))}Ae.evaluate=Wn;var rt=class t{constructor(e=null){this.parent=e,this.vars=Object.create(this.parent?this.parent.vars:null)}extend(){return new t(this)}getVar(e){if(e in this.vars)return this.vars[e];if(e in hr.builtinJqFilters)return{scope:null,value:hr.builtinJqFilters[e]};if(e in fr.builtinNativeFilters)return{scope:null,value:fr.builtinNativeFilters[e]};throw(0,tt.notDefinedError)(e)}setVar(e,r,n=this){this.vars[e]={scope:n,value:r}}getVarValue(e){return this.getVar(e).value}evaluateConditions(e,r){return Array.from(this.evaluate(e,r)).map(n=>(0,c.isTrue)(n.value))}*evaluateForeach(e,r,n=!1){for(let i of r){let s=!0,o=[];for(let d of this.evaluate(e.init,(0,c.single)(i))){let w=d,a=s?this.evaluate(e.expr,(0,c.single)(i)):o;for(let p of a){let f=this.extend();f.setVar(e.var,p.value);let h=!0;for(let g of f.evaluate(e.update,(0,c.single)(w)))h=!1,w=g,n||(e.extract?yield*f.evaluate(e.extract,(0,c.single)(g)):yield g);h&&(w=(0,c.createItem)(null)),s&&o.push(p)}s=!1,n&&(yield w)}}}*evaluate(e,r){var n,i,s,o;if(e===void 0){yield*r;return}switch(e.type){case"identity":yield*r;break;case"binary":if(e.type==="binary"&&e.operator==="|"){yield*this.evaluate(e.right,this.evaluate(e.left,r));break}for(let a of r){let p=this.evaluate(e.left,(0,c.single)(a)),f=this.evaluate(e.right,(0,c.single)(a));if((0,q.isBinaryOperatorType)(e.operator,q.BinaryOperatorType.comma))yield*p,yield*f;else if((0,q.isBinaryOperatorType)(e.operator,q.BinaryOperatorType.normal))yield*(0,se.evaluateNormalBinaryOperator)(e.operator,p,f);else if((0,q.isBinaryOperatorType)(e.operator,q.BinaryOperatorType.boolean))yield*(0,se.evaluateBooleanOperator)(e.operator,p,f);else if((0,q.isBinaryOperatorType)(e.operator,q.BinaryOperatorType.alternative))yield*(0,se.evaluateAlternativeOperator)(p,f);else if((0,q.isBinaryOperatorType)(e.operator,q.BinaryOperatorType.assignment))if(e.operator==="|="){let h=a.value;for(let g of(0,c.generatePaths)(p)){let v;for(let b of this.evaluate(e.right,(0,c.single)((0,c.createItem)((0,zn.getPath)(a.value,g))))){v=(0,c.deepClone)(b.value);break}h=(0,Kn.setPath)(h,g,v)}yield(0,c.createItem)(h)}else e.operator==="="?yield*(0,se.evaluateSimpleAssignment)(a,p,f):yield*(0,se.evaluateArithmeticUpdateAssignment)(e.operator,a,p,f);else throw new Q.JqEvaluateError(`Unexpected operator ${e.operator}`)}break;case"def":{let a=this.extend();a.setVar(e.name,e),yield*a.evaluate(e.next,r);break}case"str":for(let a of r)if(e.interpolated){let p=e.parts.map(f=>typeof f=="string"?[f]:Array.from(this.evaluate(f,(0,c.single)(a))).map(h=>(0,pr.applyFormat)(e.format,(0,c.toString)(h.value)))).reverse();for(let f of(0,oe.generateCombinations)(p))yield(0,c.createItem)(f.reverse().join(""))}else yield(0,c.createItem)(e.value);break;case"num":case"bool":case"null":for(let a of r)yield(0,c.createItem)(e.value);break;case"format":for(let a of r)yield(0,c.createItem)((0,pr.applyFormat)(e,(0,c.toString)(a.value)));break;case"filter":for(let a of r){let p=Vn.Parser.getFilterArity(e.name),f=this.getVar(e.name);if((0,Jn.isNativeFilter)(f.value)){let h=[];for(let g=0;g<p;g++){let v=e.args[g];h.push(Array.from(this.evaluate(v,(0,c.single)((0,c.createItem)(a.value)))))}for(let g of(0,oe.generateCombinations)(h))yield*f.value(a,...g)}else{let h=[];for(let g=0;g<p;g++){let v=f.value.args[g],b=e.args[g];switch(v.type){case"varArg":h.push((0,c.collectValues)(this.evaluate(b,(0,c.single)(a))));break;case"filterArg":let k={type:"def",name:v.name,args:[],body:b};h.push([k]);break}}for(let g of(0,oe.generateCombinations)(h)){let v=(i=(n=f.scope)===null||n===void 0?void 0:n.extend())!==null&&i!==void 0?i:new t;for(let b=0;b<p;b++){let k=f.value.args[b];v.setVar(k.name,g[b],this)}yield*v.evaluate(f.value.body,(0,c.single)(a))}}}break;case"if":for(let a of r){let p=[this.evaluateConditions(e.cond,(0,c.single)(a))],f=[e.then];if(p[0].includes(!1)&&e.elifs){for(let b of e.elifs)if(p.push(this.evaluateConditions(b.cond,(0,c.single)(a))),f.push(b.then),!p[p.length-1].includes(!1))break}e.else&&f.push(e.else);let h=[],g=b=>f[b]?(h[b]||(h[b]=Array.from(this.evaluate(f[b],(0,c.single)(a)))),h[b]):[];function*v(b){if(p[b])for(let k of p[b])k?yield*g(b):yield*v(b+1);else yield*g(b)}yield*v(0)}break;case"try":for(let a of r)try{for(let p of this.evaluate(e.body,(0,c.single)(a)))yield p}catch(p){if(p instanceof ae)throw p;e.catch&&(yield*this.evaluate(e.catch,(0,c.single)((0,c.createItem)(p.message))))}break;case"reduce":yield*this.evaluateForeach(Object.assign(Object.assign({},e),{type:"foreach"}),r,!0);break;case"var":for(let a of r)yield(0,c.createItem)(this.getVarValue(e.name));break;case"varDeclaration":for(let a of r)for(let p of this.evaluate(e.expr,(0,c.single)(a))){let f=new Set(t.extractVariableNames(e.destructuring));for(let h=0;h<e.destructuring.length;h++){let g=e.destructuring[h];try{for(let v of this.destructureValue(p.value,g)){let b=this.extend();for(let k of f)b.setVar(k,null);for(let[k,V]of Object.entries(v))b.setVar(k,V);yield*b.evaluate(e.next,(0,c.single)(a))}break}catch(v){if(h+1>=e.destructuring.length)throw v}}}break;case"foreach":yield*this.evaluateForeach(e,r);break;case"label":try{yield*this.evaluate(e.next,r)}catch(a){if(a instanceof ae){if(a.value!==e.value)throw a;break}else throw a}break;case"break":throw new ae(e.value);case"unary":let{operator:d,type:w}=e;if(e.operator==="-"){for(let a of r)for(let p of this.evaluate(e.expr,(0,c.single)(a)))yield(0,c.createItem)(-p.value);break}throw(0,tt.notImplementedError)(`${w}:${d}`);case"index":for(let a of r)for(let p of this.evaluate(e.expr,(0,c.single)(a)))if(typeof e.index=="string")yield(0,c.createItem)((0,c.access)(p.value,e.index),[...p.path,e.index]);else for(let f of this.evaluate(e.index,(0,c.single)(a)))yield(0,c.createItem)((0,c.access)(p.value,f.value),[...p.path,f.value]);break;case"slice":for(let a of r){let p=e.from?Array.from(this.evaluate(e.from,(0,c.single)(a))):[void 0],f=e.to?Array.from(this.evaluate(e.to,(0,c.single)(a))):[void 0];for(let h of this.evaluate(e.expr,(0,c.single)(a))){if(!(0,c.typeIsOneOf)(h.value,c.Type.array,c.Type.string,c.Type.null))throw(0,tt.cannotSliceError)(h.value);for(let g of p){if(g!==void 0&&(0,c.typeOf)(g.value)!==c.Type.number)throw dr();for(let v of f){if(v!==void 0&&(0,c.typeOf)(v.value)!==c.Type.number)throw dr();let b=(0,c.createSliceAccessor)((s=g?.value)!==null&&s!==void 0?s:null,(o=v?.value)!==null&&o!==void 0?o:null);yield(0,c.createItem)((0,c.access)(h.value,b),[...h.path,b])}}}}break;case"iterator":for(let a of r)for(let p of this.evaluate(e.expr,(0,c.single)(a)))switch((0,c.typeOf)(p.value)){case"array":for(let f=0;f<p.value.length;f++)yield(0,c.createItem)(p.value[f],[...p.path,f]);break;case"object":for(let[f,h]of Object.entries(p.value))yield(0,c.createItem)(h,[...p.path,f]);break;default:throw Rn(p.value)}break;case"array":for(let a of r)e.expr?yield(0,c.createItem)((0,c.collectValues)(this.evaluate(e.expr,(0,c.single)(a)))):yield(0,c.createItem)([]);break;case"object":for(let a of r)yield*(0,c.generateItems)((0,Bn.generateObjects)(e.entries.map(({key:p,value:f})=>[typeof p=="string"?[p]:(0,c.collectValues)(this.evaluate(p,(0,c.single)(a))),f===void 0?[a.value[p]]:(0,c.collectValues)(this.evaluate(f,(0,c.single)(a)))])));break;case"recursiveDescent":for(let a of r)yield*(0,c.generateItems)((0,c.recursiveDescent)(a.value));break}}static*extractVariableNames(e){for(let r of e)switch(r.type){case"var":yield r.name;break;case"arrayDestructuring":{for(let n of r.destructuring)yield*t.extractVariableNames([n]);break}case"objectDestructuring":for(let n of r.entries)n.destructuring?yield*t.extractVariableNames([n.destructuring]):yield n.key.name;break}}*destructureValue(e,r){switch(r.type){case"var":yield{[r.name]:e};break;case"arrayDestructuring":{if((0,c.typeOf)(e)!=="array")throw new Q.JqEvaluateError(`${(0,c.typeOf)(e)} cannot be destructured as an array`);let i=r.destructuring.map((s,o)=>Array.from(this.destructureValue(e[o],r.destructuring[o])));for(let s of(0,oe.generateCombinations)(i))yield Object.assign({},...s);break}case"objectDestructuring":if((0,c.typeOf)(e)!=="object")throw new Q.JqEvaluateError(`${(0,c.typeOf)(e)} cannot be destructured as an object`);let n=r.entries.map(i=>{if(i.destructuring)return typeof i.key=="string"?Array.from(this.destructureValue(e[i.key],i.destructuring)):(0,c.collectValues)(this.evaluate(i.key,(0,c.single)((0,c.createItem)(e)))).map(o=>Array.from(this.destructureValue(e[o],i.destructuring))).flat();{let s=i.key.name,o=i.key.name.substring(1),d=e[o];return[{[s]:d}]}});for(let i of(0,oe.generateCombinations)(n))yield Object.assign({},...i.reverse());break}}}});var mr=_(Ne=>{"use strict";Object.defineProperty(Ne,"__esModule",{value:!0});Ne.jqTemplateTag=void 0;var Ln=K(),Un=nt();function Gn(t){let e=t.join(""),r=(0,Ln.parse)(e);return n=>(0,Un.evaluate)(r,n)}Ne.jqTemplateTag=Gn});var et=_(j=>{"use strict";Object.defineProperty(j,"__esModule",{value:!0});j.jq=j.evaluate=j.print=j.parse=j.format=void 0;var yr=(jt(),kr(Ot));yr.__exportStar(St(),j);yr.__exportStar(P(),j);var Zn=At();Object.defineProperty(j,"format",{enumerable:!0,get:function(){return Zn.format}});var Xn=K();Object.defineProperty(j,"parse",{enumerable:!0,get:function(){return Xn.parse}});var Hn=Ke();Object.defineProperty(j,"print",{enumerable:!0,get:function(){return Hn.print}});var Yn=nt();Object.defineProperty(j,"evaluate",{enumerable:!0,get:function(){return Yn.evaluate}});var Qn=mr();Object.defineProperty(j,"jq",{enumerable:!0,get:function(){return Qn.jqTemplateTag}})});var ei=Er(et());window.jq=ei;
